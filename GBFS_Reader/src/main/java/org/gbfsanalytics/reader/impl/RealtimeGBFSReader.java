...
public class RealtimeGBFSReader extends AbstractPollingGBFSReader {
    ...
    public RealtimeGBFSReader(String autoDiscoverURL, Long pollingInterval, String feedFileType, Consumer<JsonObject> callBack) {
        this.autoDiscoverURL = autoDiscoverURL;
        this.pollingInterval = pollingInterval;
        this.feedFileType = feedFileType;
        ...
        pollTimer.schedule(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    JsonObject data= feedDataObj.getAsJsonObject("data");
